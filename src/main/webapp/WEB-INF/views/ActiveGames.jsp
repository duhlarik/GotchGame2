...
<p><b>${username}</b><br>
<h3>Target: ${target}</h3><br>
<h3>Item: ${item}</h3><br>
<h3>Location: ${location}</h3><br>
<h1>${nullmessage} </h1><br></p>

<form action= "GotchaGoToUploadPhotos" method ="get"><br>
...
<form action="Outdoor2" method="get"><br>
<input type="submit" value="Photos"><br>
</form>	
</body>
</html>